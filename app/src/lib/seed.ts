...
export const CLIENTS_SEED: Client[] = [
  {
    ...
    allergies: 'Лактоза — вздутие от цельного молока, кисломолочку переносит нормально',
    conditions: 'Гипотиреоз (компенсирован, на заместительной терапии)',
    preferences: 'Любит рыбу и морепродукты, не ест грибы, предпочитает средиземноморскую кухню',
    activityLevel: 1.375,
    ...
    foodFrequency: {
      ...
      vegetables: { frequency: 'daily', portion: 'large' },
      sugar: { frequency: 'few_week', portion: 'small' },
      processed: { frequency: 'rarely', portion: 'small' },
    },
    weightHistory: [
  ...
  },
  {
    ...
    monthlyFee: 22000,
    nextPaymentDate: daysAgo(-18),
    notes: 'Набор массы, силовые 4х/нед. Нужно поднять углеводы в тренировочные дни.',
    allergies: 'Аллергий не выявлено',
    conditions: '',
    preferences: 'Любит мясо и крупы, не любит рыбу',
    weightHistory: [
  ...
  },
  {
    ...
    allergies: 'Непереносимость глютена (по самоощущению, целиакия не подтверждена)',
    conditions: 'СРК (синдром раздражённого кишечника)',
    preferences: 'Предпочитает лёгкие блюда, избегает острого',
    weightHistory: [
  ...
  },
  {
    ...
    conditions: '',
    preferences: 'Любит молочное и крупы, ест всё',
    activityLevel: 1.725,
    weightHistory: [
...
export const CAREER_LEADS_SEED: CareerLead[] = [
  ...
  },
  {
    id: 'lead-hh1',
    kind: 'partner',
    title: 'Нутрициолог-консультант в сеть клиник',
    org: 'hh.ru · вакансия работодателя',
    format: 'offline',
    city: 'Москва',
    payout: 80000,
    minRating: 4.0,
    matchReason: 'Похожие вакансии на hh.ru по запросу «нутрициолог»',
    status: 'new',
    postedAt: hoursAgo(6),
    source: 'hh',
    externalUrl: 'https://hh.ru/search/vacancy?text=нутрициолог&area=1',
  },
  {
    id: 'lead-hh2',
    kind: 'partner',
    title: 'Диетолог-нутрициолог, частная практика при клинике',
    org: 'hh.ru · вакансия работодателя',
    format: 'offline',
    city: 'Санкт-Петербург',
    payout: 65000,
    ...
    source: 'hh',
    externalUrl: 'https://hh.ru/search/vacancy?text=нутрициолог&area=2',
  },
];

/** Extra hh.ru-style leads rotated in by the demo "auto-refresh" — not part of the initial feed. */
export const HH_LEAD_POOL: CareerLead[] = [
  {
    id: 'lead-hh3',
    kind: 'partner',
    title: 'Нутрициолог для онлайн-школы похудения',
    org: 'hh.ru · вакансия работодателя',
    format: 'online',
    city: 'вся Россия',
    payout: 55000,
    ...
    postedAt: hoursAgo(1),
    source: 'hh',
    externalUrl: 'https://hh.ru/search/vacancy?text=нутрициолог&area=113',
  },
  {
    id: 'lead-hh4',
    kind: 'partner',
    title: 'Специалист по питанию в фитнес-холдинг',
    org: 'hh.ru · вакансия работодателя',
    format: 'offline',
    city: 'Екатеринбург',
    payout: 70000,
  ...
  },
  {
    id: 'lead-hh5',
    kind: 'partner',
    title: 'Консультант по питанию в корпоративный wellness',
    org: 'hh.ru · вакансия работодателя',
    format: 'online',
    city: 'вся Россия',
    payout: 62000,
  ...
  },
  {
    id: 'lead-hh6',
    kind: 'partner',
    title: 'Нутрициолог в медицинский центр',
    org: 'hh.ru · вакансия работодателя',
    format: 'offline',
    city: 'Новосибирск',
    payout: 58000,
...
export const SOCIAL_MENTIONS_POOL: SocialMention[] = [
  {
    id: 's1',
    platform: 'vk',
    author: 'Марина К.',
    snippet: 'Девочки, ищу нутрициолога онлайн, кто может посоветовать? Хочу разобраться с питанием после родов.',
    foundAt: hoursAgo(3),
  },
  {
    id: 's2',
    platform: 'telegram',
    author: '@wellness_chat_msk',
    snippet: 'Нужен специалист по питанию, посоветуйте нутрициолога с опытом работы с СРК, живу в Москве.',
    foundAt: hoursAgo(9),
  },
  {
    id: 's3',
    platform: 'vk',
    author: 'Игорь П.',
    snippet: 'Подскажите, где искать нутрициолога для спортсмена — готовлюсь к соревнованиям, нужна коррекция рациона.',
    foundAt: hoursAgo(14),
  },
  {
    id: 's4',
    platform: 'telegram',
    author: '@fitness_community',
    snippet: 'Ищу нутрициолога для группы — планируем корпоративный марафон похудения на 3 месяца.',
    foundAt: hoursAgo(20),
  },
  {
    id: 's5',
    platform: 'vk',
    author: 'Анастасия В.',
    snippet: 'Всем привет! Нужен нутрициолог, который работает с подростками, дочке 14 лет, есть вопросы по питанию.',
    foundAt: hoursAgo(28),
  },
  {
    id: 's6',
    platform: 'telegram',
    author: '@mama_forum',
    snippet: 'Посоветуйте специалиста по питанию для беременных, ищу нутрициолога с медицинским бэкграундом.',
    foundAt: hoursAgo(35),
  },
  {
    id: 's7',
    platform: 'vk',
    author: 'Дмитрий С.',
    snippet: 'Интересует набор массы без вреда для ЖКТ, ищу нутрициолога, кто разбирается в спортивном питании.',
    foundAt: hoursAgo(46),
  },
  {
    id: 's8',
    platform: 'telegram',
    author: '@zoj_chat',
    snippet: 'Кто-нибудь может порекомендовать нутрициолога? Хочу наладить питание, но не знаю, с чего начать.',
    foundAt: hoursAgo(52),
  },
];
